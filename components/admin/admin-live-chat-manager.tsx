        ...
        {conversations.length === 0 ? (
          ...
          conversations.map((conversation) => (
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <p
                  className={`truncate text-sm ${
                    conversation.unreadCount > 0 ? "font-bold text-zinc-950" : "font-semibold text-zinc-900"
                  }`}
                >
              ...
              <p className={`truncate text-xs ${conversation.unreadCount > 0 ? "font-medium text-zinc-700" : "text-zinc-500"}`}>
                {conversation.customerEmail}
              </p>
              <p className={`truncate text-xs ${conversation.unreadCount > 0 ? "font-semibold text-zinc-800" : "text-zinc-600"}`}>
